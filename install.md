...
You need to get the latest bits of [.NET Core](https://www.microsoft.com/net/download).

## 2) Microsoft SQL Server

There are two ways to install Microsoft SQL Server.
...
RelationalGit is a [dotnet Global tool](https://www.nuget.org/packages/RelationalGit) from prior works. You can use it seamlessly with your favorite command-line application. The following line installs our tool on your system. After installation, all interactions will go through the command-line interface. This tool has been downloaded over 11000 times.
